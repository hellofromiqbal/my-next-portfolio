...
const About = () => {
  return (
    <section id='#about' className='flex flex-col gap-4 pb-24'>
      <p className='text-tertiary'>In 2020, I worked in <span className='text-secondary font-medium'>customer service</span> at a private bank in Indonesia, using various web applications for customer data. These apps lacked integration, requiring me to perform the same tasks in different applications. This experience sparked my <span className='text-secondary font-medium'>curiosity</span> about programming and <span className='text-secondary font-medium'>web development</span>.</p>
